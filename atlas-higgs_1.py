...
def autoencoder():
    ...
    autoencoder.add(Dense(encoded_dims, input_dim=cols))
...
X_b_train, X_b_test, y_b_train, y_b_test = train_test_split(X_b, y_b, train_size=0.8)
...
# Preprocessing: imputing of NaN values and min/max normalization
imputer = Imputer()
